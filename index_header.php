...
<body>
  <header>
    <div class="logo">
    <a href="index.php"><b><h1 style="color:black; font-size:x-large">Online Book Store </h1></b>
    ...
    <div class="nav">
        ...
        <div class="dropdown">
            ...
            <a href="http://localhost/bookflix/index.php#New">New Arrieved</a>
                <a href="http://localhost/bookflix/index.php#Adventure">Mythalogical</a>
